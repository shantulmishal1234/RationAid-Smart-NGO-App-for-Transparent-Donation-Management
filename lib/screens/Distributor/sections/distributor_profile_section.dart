...
/// Distributor Profile Section - User information and activity summary
...
class _DistributorProfileSectionState extends State<DistributorProfileSection> {
  ...
  Future<void> _loadStats() async {
    ...
    try {
      final queryShot = await FirebaseFirestore.instance
          ...
          .where('assignedDistributorId', isEqualTo: userId)
          .get();
      ...
      final uniqueFamilies = completedDocs.map((d) => d['familyId']).toSet();
      int familiesHelped = uniqueFamilies.length;
      ...
      debugPrint('Error loading distributor stats: $e');
    }
  }
  ...
  Widget _buildPhotoSourceOption({
    ...
    final c = color ?? AppColors.volunteerBlue;
            ...
            _SupportOption(
              ...
              onTap: () async {
                final uri = Uri(
                  ...
                  queryParameters: {'subject': 'Distributor Support Request'},
                );
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon, color: AppColors.volunteerBlue, size: 22),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: Column(
...
class _SettingsTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = iconColor ?? AppColors.volunteerBlue;
    return ListTile(
      contentPadding: EdgeInsets.zero,
      leading: Container(
        padding: const EdgeInsets.all(10),
